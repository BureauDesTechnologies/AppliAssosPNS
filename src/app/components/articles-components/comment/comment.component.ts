...
export class CommentComponent implements OnInit {
    ...
    async ngOnInit() {
        if ((this.comment.author.photoUrl !== null && this.comment.author.photoUrl !== undefined)
            && this.comment.author.photoUrl !== '') {
            // this.userService.getDownloadUrl(this.comment.author.photoUrl);
            if ((this.comment.author.downloadPhotoUrl !== null && this.comment.author.downloadPhotoUrl !== undefined)
                && this.comment.author.downloadPhotoUrl !== '') {
